...
VALID_FILE_TYPES = ('.md', '.jpg', '.png', 'jpeg', 'gif', 'svg', '.pdf')
...
def delete_empty_folders():
    for file_dir, _, _ in os.walk(VAULT_PATH, topdown=False):
        if not os.listdir(file_dir) and file_dir != VAULT_PATH:
            os.rmdir(file_dir)

def delete_buffer_contents():
